...
_cnss2_enabled_target = ["seraph", "neo-la", "anorak", "niobe", "pineapple", "houji", "sun", "sdxkova", "sa510m", "autogvm", "autoghgvm"]
_icnss2_enabled_target = ["blair", "pineapple", "houji", "monaco", "pitti", "volcano"]
